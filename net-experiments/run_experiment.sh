...
# rm *.tsv
mv *.tsv all_subtuns_time_inflight_cwnd.pdf tentry_logs iperf_server_output.csv iperf_tentry.log  delay_variations afmt_pdv.pdf Throughput.pdf $results_dir
