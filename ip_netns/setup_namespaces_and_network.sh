...
tc -netns T_entry qdisc add dev veth21 root handle 20: netem delay 35ms rate 16mbit
...
tc -netns T_exit qdisc add dev veth22 root handle 20: netem delay 35ms rate 16mbit
